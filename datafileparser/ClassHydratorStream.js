...
class ClassHydratorStream extends Transform {
    constructor(options) {
        super(_.extend({
            objectMode: true
        }, options));
        this.types = options.types;
        console.log('ClassHydratorStream options: ' + util.inspect(options));
    }
}
...
ClassHydratorStream.prototype._transform = function(chunk, encoding, done) {
    var obj = {};
...
module.exports = ClassHydratorStream;